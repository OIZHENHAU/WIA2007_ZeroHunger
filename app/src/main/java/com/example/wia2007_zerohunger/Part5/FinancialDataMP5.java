...
public class FinancialDataMP5 {
    ...
    public FinancialDataMP5(String monthID, String monthName, int monthExpenses, int monthEFB, int monthEUtilities, int monthEFundTransfers, int monthETransport, int monthEServices, int monthEOthers,
